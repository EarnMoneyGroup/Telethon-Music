...
async def start(event):
    ...
    if event.is_private:
       await event.client.send_file(event.chat_id,
        ...
        [Button.url("📲 𝐑𝐞𝐠𝐢𝐬𝐭𝐞𝐫", f"http://www.9987up.cc/#/register?r_code=82127507")],
        [Button.url("📁 𝐂𝐡𝐚𝐧𝐧𝐞𝐥", f"https://t.me/LotteryAdvisorOfficial"), Button.url("👤 𝐂𝐨𝐧𝐭𝐚𝐜𝐭", f"https://t.me/krishnavardaan")],
...
async def start(event):
     if event.is_group:
       await event.reply("**Register now!**",buttons=[
        [Button.url("Register Here 🤍", f"http://www.9987up.cc/#/register?r_code=82127507")]])
       return
...
async def start(event):
     if event.is_group:
       await event.reply("**I know you want to earn money, Come and join**",buttons=[
        [Button.url("Check it out 🌐", f"https://t.me/LotteryAdvisorOfficial")]])
       return
...
async def start(event):
     if event.is_group:
       await event.reply("**Contact Us Now**",buttons=[
        [Button.url("Hello 📞", f"https://t.me/krishnavardaan")]])
       return
